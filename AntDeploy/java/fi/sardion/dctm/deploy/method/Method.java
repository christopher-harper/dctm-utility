...
/**
 * This is an ant task for creating and updating a dm_method object. The method
 * task is nested in the {@link fi.sardion.dctm.deploy.session.Session session}
 * task and must be called <code><b>servermethod</b></code>.
 * <p>
 * <ul>
...
public class Method extends DCTMTask {
    ...
    /**
     * Extended method properties. Defaults to just one entry:
     * <code>JMS_LOCATION=ANY</code>.
     * <ul>
     ...
     * @since %since%
     */
    private List<String> extendedProperties = Arrays
	    .asList(new String[] { "JMS_LOCATION=ANY" }); //$NON-NLS-1$
    /**
    ...
    /**
     * Add possible job objects for this method. A single method can have
     * multiple jobs that execute the same method.
     * <ul>
     ...
     * </ul>
     * 
     * @param aJob the job ant task definition.
     * @since %since%
     */
    ...
    /**
     * Execute the method task and all defined
     * {@link fi.sardion.dctm.deploy.job.Job job} subtasks.
     * <ul>
	...
	try {
		...
		final String qualification = new StringBuilder().append(
		        DCTMTask.DM_METHOD).append(" where ").append( //$NON-NLS-1$
		        DCTMTask.OBJECT_NAME).append(" = '") //$NON-NLS-1$
		        .append(getMethodName()).append('\'').toString();
		IDfMethodObject method = (IDfMethodObject) session
		...
		if (method == null) {
		    ...
		    method = (IDfMethodObject) session
			    .newObject(DCTMTask.DM_METHOD);
    ...
    /**
     * Set the extended properties. <b>NOTE</b>: This is a comma (,) separated
     * list that is turned to a List using
     ...
     * </ul>
     * 
     * @param theExtendedProperties the extended properties.
     * @since %since%
     */
    public void setExtendedproperties(final String theExtendedProperties) {
	this.extendedProperties = Arrays.asList(theExtendedProperties
	        .split(",")); //$NON-NLS-1$
    }

    /**
     * Set whether the job is restartable. <b>NOTE</b>: String value passed in
     * is transformed to a boolean using
     ...
     * </ul>
     * 
     * @param restartable can the job be restarted.
     * @since %since%
     */
    ...
    /**
     * Set whether the method should be launched asynchronously. <b>NOTE</b>:
     ...
     * </ul>
     * 
     * @param launchAsync should the method should be launched asynchronously.
     * @since %since%
     */
    public void setLaunchasync(final String launchAsync) {
	this.launchAsync = Boolean.parseBoolean(launchAsync);
    }

    /**
     * Should the method should be launched immediately. <b>NOTE</b>: String
     ...
     * </ul>
     * 
     * @param aLaunchDirect should the method should be launched immediately.
     * @since %since%
     */
     ...
     * that is turned to a List using
     * <code>Arrays.asList(String.split(","));</code>
     * <ul>
     ...
     * </ul>
     * 
     * @param theMethodArguments arguments save on the method object.
     * @since %since%
     */
    ...
    /**
     * Set the name of the method. The name uniquely identifies the method in
     * the repository.
     * <ul>
     ...
     * </ul>
     * 
     * @param theMethodType type of the method.
     * @since %since%
     */
     ...
     * </ul>
     * 
     * @param aMethodVerb the method verb.
     * @since %since%
     */
    ...
    /**
     * Set whether to run as super user. <b>NOTE</b>: String value passed in is
     ...
     * </ul>
     * 
     * @param aRunAsServer whether to run as server.
     * @since %since%
     */
    ...
    /**
     * Sets the success return codes. <b>NOTE</b>: This is a comma (,) separated
     * list that is turned to a List using
     * <code>Arrays.asList(String.split(","));</code> and then each element is
     * converted to an Integer using <code>new Integer(code)</code>.
     * <ul>
     * <li>Created: 18 Sep 2010 19:33:11</li>
     * <li>Author: Christopher Harper, account: dmadmin</li>
     * </ul>
     * 
     * @param theSuccessReturnCodes the success return codes.
     * @since %since%
     */
    public void setSuccessreturncodes(final String theSuccessReturnCodes) {
	final List<String> codes = Arrays.asList(theSuccessReturnCodes
	        .split(",")); //$NON-NLS-1$
     ...
     * </ul>
     * 
     * @param aSuccessStatus the success status.
     * @since %since%
     */
    ...
    /**
     * Sets the default timeout. <b>NOTE</b>: String value passed in is
     * transformed to a int using <code>Integer.parseInt(String);</code>
     * <ul>
    ...
    /**
     * Sets the maximum timeout. <b>NOTE</b>: String value passed in is
     * transformed to a int using <code>Integer.parseInt(String);</code>
     * <ul>
    ...
    /**
     * Sets the minimum timeout. <b>NOTE</b>: String value passed in is
     * transformed to a int using <code>Integer.parseInt(String);</code>
     * <ul>
     ...
     * </ul>
     * 
     * @param timeOut the minimum timeout.
     * @since %since%
     */
    ...
    /**
     * Sets whether to trace the launch. <b>NOTE</b>: String value passed in is
     * transformed to a boolean using <code>Boolean.parseBoolean(String);</code>
     * <ul>
     ...
     * </ul>
     * 
     * @param aTraceLaunch whether to trace the launch.
     * @since %since%
     */
    ...
    /**
     * Sets whether to use the method content. <b>NOTE</b>: String value passed
     * in is transformed to a boolean using
     * <code>Boolean.parseBoolean(String);</code>
     * <ul>
     ...
     * </ul>
     * 
     * @param aUseMethodContent should the method content be used.
     * @since %since%
     */
    ...
    /**
     * Sets whether to use the method server. <b>NOTE</b>: String value passed
     * in is transformed to a boolean using
     * <code>Boolean.parseBoolean(String);</code>
     * <ul>
     ...
     * </ul>
     * 
     * @param aUseMehtodServer should a method server be used.
     * @since %since%
     */
    ...
    /**
     * Get a list of {@link fi.sardion.dctm.deploy.job.Job job} tasks defined
     * for this method.
     * <ul>
